...
if opt.network == '' then
  ...
  -- model_G:add(nn.Linear(opt.noiseDim, 128*8*8))
  -- model_G:add(nn.Reshape(128, 8, 8))
  ...
  -- model_G:add(cudnn.ReLU(true))
  -- model_G:add(nn.SpatialUpSamplingNearest(2))
  -- model_G:add(cudnn.SpatialConvolution(256, 256, 5, 5, 1, 1, 2, 2))
  -- model_G:add(nn.SpatialBatchNormalization(256))
  -- model_G:add(cudnn.ReLU(true))
  -- model_G:add(nn.SpatialUpSamplingNearest(2))
  ...
  -- model_G:add(cudnn.ReLU(true))
  -- model_G:add(cudnn.SpatialConvolution(128, 3, 3, 3, 1, 1, 1, 1))
