...
from reinforcer.neural_q_learner import NeuralQLearner
...
def observation_to_action(states):
    ...
    actions = tf.matmul(h1, W2) + b2
    return actions

q_learner = NeuralQLearner(sess, optimizer, observation_to_action,
